    ...
    private AdapterView.OnItemClickListener onClickListener = new AdapterView.OnItemClickListener() {
        ...
        public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
            ...
            dialog.setTitle("메세지 보내기")
                    .setMessage("해당 손님에게 대기완료를 알리시겠습니까?" )
                    .setPositiveButton("네", new DialogInterface.OnClickListener() {
                        @Override
                        public void onClick(DialogInterface dialog, int which) {
                            Toast.makeText(MainPostActivity.this, "메세지를 전송했습니다..", Toast.LENGTH_SHORT).show();
                        }
                    })
                    .setNegativeButton("아니오", new DialogInterface.OnClickListener() {
                        @Override
                        public void onClick(DialogInterface dialog, int which) {
                            Toast.makeText(MainPostActivity.this, "메세지 전송을 취소했습니다.", Toast.LENGTH_SHORT).show();
