...
import com.example.managestore.CAFE.NetworkUtil;
import com.example.managestore.CAFE.PHPRequest;

import java.net.MalformedURLException;

public class StoreStart extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.storestart);
